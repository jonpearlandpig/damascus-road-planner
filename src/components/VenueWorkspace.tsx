    ...
    <div className="workspace-page">
      ...
      <div className="workspace-layout">
        ...
        <main className="workspace-main">
          ...
          <div className="bottom-control-bar"><div><span>Venue revision</span><strong>{venue.sourceYear}</strong></div><div><span>Tour package</span><strong>DRT Working v12</strong></div><button><MapPinned size={16} /> Saved views</button><button><Cable size={16} /> Measure</button></div>
