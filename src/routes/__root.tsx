  ...
  head: () => ({
    meta: [
      ...
      { title: "DRT Venue Twin · Spring 2027 Tour" },
      {
        name: "description",
        content:
          "Production-planning platform for the 19-show Damascus Road Tour Spring 2027 — venue twins, tour package, per-show placement.",
      },
      { name: "author", content: "Damascus Road Tour" },
      { property: "og:title", content: "DRT Venue Twin · Spring 2027 Tour" },
      {
        property: "og:description",
        content: "19-venue tour dashboard, calibrated venue twins and DRT production placement.",
      },
