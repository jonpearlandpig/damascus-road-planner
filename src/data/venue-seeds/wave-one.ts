...
const vanAndelConflictedSource = venueSource(vanAndelFile, 'Venue geometry seed', '01.01.2026 source registered', 'Authored planning geometry retained with unresolved source conflict', 'UNVERIFIED');
const vanAndelGeometryProvenance = geometryProvenance(vanAndelGeometry, 'ESTIMATE', 'LOW', vanAndelConflictedSource, 'Registered Van Andel source remains unresolved; treat authored geometry as an estimate until the grid-height conflict is reconciled.');
...
export const waveOneA: VenueTwin[] = [
  {
    ...
    approvedReviewFactIds: {
      dockCount: 'dickies-event-docks-5',
      pushDistanceFt: 'dickies-push-distance-175',
      stageEndOpeningWidthFt: 'dickies-stage-opening-width-18-5',
      stageEndOpeningHeightFt: 'dickies-stage-opening-height-36',
      totalGridRiggingLb: 'dickies-total-rigging-200000',
      centerhungBottomFt: 'dickies-scoreboard-concert-trim-80',
      houseStageWidthFt: 'dickies-house-stage-width-80',
      houseStageDepthFt: 'dickies-house-stage-depth-40',
    },
    zones: [
  ...
  },
  {
    ...
    sourceScore: 35, sourceYear: 'January 1, 2026 source registered', sourceFile: vanAndelFile, fidelity: 'L0 SOURCE', sourceStatus: 'CONFLICT', cadStatus: 'REQUESTED',
    riggingConfidence: 'CONFLICT', logisticsConfidence: 'UNVERIFIED', pmOpen: 6, tmOpen: 3,
    keyStrength: 'Filed venue source is registered, but the grid-height definition remains unresolved.',
    missingInputs: ['Resolve 84 ft 7 in vs 86 ft grid height definitions', 'Native rigging CAD', 'Current seating manifest'], detailed: true,
    geometry: vanAndelGeometry,
    geometryProvenance: vanAndelGeometryProvenance,
    approvedReviewFactIds: {
      floorWidthFt: 'vaa-floor-width-85',
      floorLengthFt: 'vaa-floor-length-200',
      highSteelFt: 'vaa-high-steel-98',
      gridWidthFt: 'vaa-grid-width-99',
      gridDepthFt: 'vaa-grid-depth-52',
      centerhungBottomFt: 'vaa-scoreboard-bottom-65',
      dockCount: 'vaa-docks-5',
      houseStageWidthFt: 'vaa-house-stage-width-60',
      houseStageDepthFt: 'vaa-house-stage-depth-40',
    },
    zones: [
      { id: 'vaa-docks', label: 'Five loading docks', kind: 'dock', xFt: -30, zFt: -94, widthFt: 38, depthFt: 18, layer: 'logistics', source: venueSource(vanAndelFile, 'Loading Dock', '01.01.2026 source registered', 'Five docks; Dock 5 door 20 ft x 18 ft', 'UNVERIFIED') },
      { id: 'vaa-horseshoe', label: 'Secure horseshoe parking', kind: 'parking', xFt: 30, zFt: -96, widthFt: 35, depthFt: 20, layer: 'logistics', source: venueSource(vanAndelFile, 'Tour Parking', '01.01.2026 source registered', 'Secure gated horseshoe lot', 'UNVERIFIED') },
      { id: 'vaa-pa-left', label: 'House PA obstruction HL', kind: 'obstruction', xFt: -22, zFt: -5, widthFt: 6, depthFt: 12, heightFt: 20, layer: 'rigging', source: venueSource(vanAndelFile, 'Rigging', '01.01.2026 source registered', 'House PA obstruction 22 ft off center', 'UNVERIFIED') },
      { id: 'vaa-pa-right', label: 'House PA obstruction HR', kind: 'obstruction', xFt: 22, zFt: -5, widthFt: 6, depthFt: 12, heightFt: 20, layer: 'rigging', source: venueSource(vanAndelFile, 'Rigging', '01.01.2026 source registered', 'House PA obstruction 22 ft off center', 'UNVERIFIED') },
    ],
    objects: baseObjects(vanAndelFile, '01.01.2026 source registered', '85 ft x 200 ft estimate', '84 ft 7 in / 86 ft unresolved grid-height references', '65 ft centerhung trim reference', 'CONFLICT', 'UNVERIFIED', 'UNVERIFIED'),
  },
];
