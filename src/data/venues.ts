...
export const venues: VenueTwin[] = [
  ...
  placeholder('gainbridge-fieldhouse', 'Gainbridge Fieldhouse', 'Indianapolis', 'IN', '2027-04-10', 60, 'READY', 'gainbridge_fieldhouse_indianapolis_in.pdf'),
  map['van-andel-arena'],
  ...
  placeholder('giant-center', 'GIANT Center', 'Hershey', 'PA', '2027-04-16', 0, 'READY', 'giant_center_hershey_pa.pdf'),
  map['spectrum-center'],
  ...
  placeholder('target-center', 'Target Center', 'Minneapolis', 'MN', '2027-04-24', 0, 'READY', 'target_center_minneapolis_mn.pdf'),
  map['t-mobile-center'],
  ...
  placeholder('red-rocks', 'Red Rocks Amphitheatre', 'Morrison', 'CO', '2027-05-04', 58, 'STALE', 'red_rocks_amphitheatre_morrison_co.pdf'),
